...
export const User = ({
  ...
  <li>
    ...
    {/* При нажатии на изображение плюса добавляется флаг isInvited и происходит проверка, если он есть (значение true),  то появляется изображение минуса и наоборот */}
    {/* При нажатии вызывается функция onClickInvite, вкоторую аргументом передается id пользователя */}
    <img
